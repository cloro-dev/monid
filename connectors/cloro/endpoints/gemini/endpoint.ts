...
import { zGeminiBody } from "./schema/inputs.ts";

export default defineEndpoint({
    meta: {
        displayName: "cloro Gemini",
        summary:
            "Get Google Gemini's answer and cited sources for a prompt, in a chosen country.",
        description:
        ...
        docsUrl: "https://cloro.dev/docs/api-reference/endpoint/monitor-gemini",
    ...
    request: { method: "POST", path: "/monitor/gemini" },
    input: { schema: { body: zGeminiBody } },
    // ASYNC RUN. Measured 31–38 s per call (monid drill,
